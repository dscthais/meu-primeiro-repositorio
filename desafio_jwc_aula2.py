...
# print ("o lugar que mais recebe investimento é o da " + SETOR_MERCADO_PRINCIPAL)
...
#inguagem_favorita = input("Qual sua linguagem favorita?")
#rint (linguagem_favorita)
...
# Código:
#
#eio_transporte_utilizado = input("Qual transporte você utiliza para vir ao trabalho?")
#rint (input)
#
# rint(meio_transporte_utilizado)
...
# # Código:
# primeiro_nome = "Jessie"
# sobrenome_candidato = "Ferreira"
...
# total_remuneração_inicial = valor_salario_base + valor_auxilio_ferramentas
# print (total_remuneração_inicial)
...
# print(f" Nome: {nome_colaborador_input}, Idade {idade_colaborador_input} anos, obteve uma pontuacão {pontuacao_teste_pratico}")
